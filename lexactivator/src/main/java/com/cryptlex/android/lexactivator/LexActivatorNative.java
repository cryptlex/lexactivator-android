...
public class LexActivatorNative implements Library {
    ...
    public static native int GetFeatureEntitlementInternal(String name, ByteBuffer featureEntitlementJson, int length);
    ...
    public static native int GetActivationLastSyncedDate(IntByReference activationLastSyncedDate);
